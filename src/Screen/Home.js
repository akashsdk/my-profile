  ...
  return (
    <Layout ref={ref}>
      ...
      <Layout id="aboutMe" className="HomeLayout">
        <div style={{ flex: 1, flexDirection: "row" }}>
          <p style={{ color: "rgb(237, 158, 38)", fontSize: "50px" }}>
            Biography
          </p>
      ...
      <Layout>
        <div className="HomeEduButton">
          <button
            ...
            style={{
              color: page == 1 ? "#fff" : "rgb(237, 158, 38)",
              fontSize: "40px",
          ...
          <button
            ...
            style={{
              color: page == 2 ? "#fff" : "rgb(237, 158, 38)",
              fontSize: "40px",
              background: "transparent",
              border: "hide",
              marginLeft: "10px",
          ...
          <button
            ...
            style={{
              color: page == 3 ? "#fff" : "rgb(237, 158, 38)",
              fontSize: "40px",
              background: "transparent",
              border: "hide",
              marginLeft: "10px",
            ...
            <div>
              ...
              >
                ...
                >
                  ...
                  <p style={{ opacity: ".4", marginLeft: "20px" }}>2019-2022</p>
                </p>
                <p
                  style={{
                    fontSize: "25px",
              ...
              >
                ...
                >
                  ...
                  <p style={{ opacity: ".4", marginLeft: "20px" }}>2017-2018</p>
                </p>
                <p
                  style={{
                    fontSize: "25px",
              ...
              >
                ...
                >
                  ...
                  <p style={{ opacity: ".4", marginLeft: "20px" }}>2015-2016</p>
                </p>
                <p
                  style={{
                    fontSize: "25px",
                ...
                >
                  Lahini Secondary School, Kushtia
                </p>
                <p
                  style={{
                    fontSize: "20px",
            ...
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column" }}>
                ...
                <div style={{ display: "flex" }}>
                  ...
                  >
                    {" "}
                    Firebase Admin <br></br> Development
                  </p>
                  <div className="HomeExpRound" />
                  <div className="HomeExpRound" />
                  <div className="HomeExpRound" />
              ...
              <div style={{ display: "flex", flexDirection: "column" }}>
                ...
                <div style={{ display: "flex" }}>
                  ...
                  >
                    {" "}
                    Arduino board <br></br> Programming
                  </p>
                  <div className="HomeExpRound" />
                  <div className="HomeExpRound" />
                  <div className="HomeExpRound" />
      ...
      <Layout>
        ...
        >
          ...
          <div className="HomeExpRroBox2">
            ...
            >
              <p style={{ color: "rgb(237, 158, 38)", fontSize: "20px" }}>
                EDU PLANET
              </p>
              <p
                style={{
        ...
        >
          ...
          <div className="HomeExpRroBox2">
            <div>
              <p style={{ color: "rgb(237, 158, 38)", fontSize: "20px" }}>
                SMIRA CLUB FOR BOOKING HOTELS AND DEALS
              </p>
              <p
                style={{
                  fontSize: "35px",
