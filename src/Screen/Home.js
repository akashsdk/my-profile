      ...
      <Layout>
        <div className='HomeEduButton'>
          <button onClick={()=>{
            ...
            style={{ color: page==1 ? '#fff' : 'rgb(237, 158, 38)', fontSize: '40px', background: 'transparent', border: 'hide', }}>
            Experience
          </button>
          <div className='HomeExpLine' />
          <button onClick={()=>{
            setPage(2)
          }} style={{ color: page==2 ? '#fff' : 'rgb(237, 158, 38)', fontSize: '40px', background: 'transparent', border: 'hide', marginLeft: '10px' }}>
            Education
          </button>
          <div className='HomeExpLine' />
          <button onClick={()=>{
            setPage(3)
          }} style={{ color: page==3 ? '#fff' : 'rgb(237, 158, 38)', fontSize: '40px', background: 'transparent', border: 'hide', marginLeft: '10px' }}>
            Skills
          </button>
        </div>
